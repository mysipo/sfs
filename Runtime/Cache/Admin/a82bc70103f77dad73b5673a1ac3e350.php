...
<script>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>频道</h2>
	</div>
	<div class="tab-wrap">
			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" name="cl_title" class="text input-large" value="<?php echo ((isset($info["cl_title"]) && ($info["cl_title"] !== ""))?($info["cl_title"]):''); ?>">
						</div>
					</div>
			        <div class="form-item">
						<label class="item-label">副标题</label>
						<div class="controls">
							<input type="text" name="cl_subtitle" class="text input-5x" value="<?php echo ((isset($info["cl_subtitle"]) && ($info["cl_subtitle"] !== ""))?($info["cl_subtitle"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">排序</label>
						<div class="controls">
							<input type="text" name="cl_sort" class="text input-2x" value="<?php echo ((isset($info["cl_sort"]) && ($info["cl_sort"] !== ""))?($info["cl_sort"]):'0'); ?>" onkeyup="if(/\D/.test(this.value)){this.value='';}" maxlength="4">
						</div>
					</div>
					<div class="form-item">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="cl_tag"><?php echo ((isset($info["cl_tag"]) && ($info["cl_tag"] !== ""))?($info["cl_tag"]):''); ?></textarea>
							</label>
						</div>
					</div>
					<div class="form-item">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="cl_desc"><?php echo ((isset($info["cl_desc"]) && ($info["cl_desc"] !== ""))?($info["cl_desc"]):''); ?></textarea>
							</label>
						</div>
					</div>
				...
				<div class="form-item">
					<input type="hidden" name="cl_id" value="<?php echo ((isset($info["cl_id"]) && ($info["cl_id"] !== ""))?($info["cl_id"]):''); ?>">
	...
	<script type="text/javascript">
		<?php if(isset($info["cl_id"])): ?>Think.setValue("allow_publish", <?php echo ((isset($info["allow_publish"]) && ($info["allow_publish"] !== ""))?($info["allow_publish"]):1); ?>);
		...
		//导航高亮
		highlight_subnav('<?php echo U('Class/index');?>');
	</script>
