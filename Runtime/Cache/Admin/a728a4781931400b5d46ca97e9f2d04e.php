  ...
  <div class="row"> 
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-6">    
    <form action="<?php echo U();?>" method="post" class="form" role="form" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="group" value="<?php echo ((isset($info["group"]) && ($info["group"] !== ""))?($info["group"]):''); ?>">
