...
<script>
	...
	<div class="main-title">
		<h2><?php echo isset($info['t_id'])?'编辑':'新增';?>系列</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item">
						<div class="controls">
							主题标题：&nbsp;<input type="text" name="t_title" class="text input-large" value="<?php echo ((isset($info["t_title"]) && ($info["t_title"] !== ""))?($info["t_title"]):''); ?>"><span class="check-tips">（标题不能为空）</span>
						</div>
					</div>
					...
					<div class="form-item">
						<div class="controls">
							排&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;序：
							<input type="text" name="t_sort" class="text input-3x" value="<?php echo ((isset($info["t_sort"]) && ($info["t_sort"] !== ""))?($info["t_sort"]):'0'); ?>" onkeyup="if(/\D/.test(this.value)){this.value='';}" maxlength="4">
						</div>
					</div>
					<div class="form-item">
						<div class="controls">
							副&nbsp;&nbsp;标&nbsp;&nbsp;题：
							<input type="text" name="t_subtitle" class="text input-large" value="<?php echo ((isset($info["t_subtitle"]) && ($info["t_subtitle"] !== ""))?($info["t_subtitle"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="t_tag"><?php echo ((isset($info["t_tag"]) && ($info["t_tag"] !== ""))?($info["t_tag"]):''); ?></textarea>
							</label>
						</div>
					</div>
					<div class="form-item">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="t_desc"><?php echo ((isset($info["t_desc"]) && ($info["t_desc"] !== ""))?($info["t_desc"]):''); ?></textarea>
							</label>
						</div>
					</div>
				...
				<div class="form-item">
					<input type="hidden" name="t_id" value="<?php echo ((isset($info["t_id"]) && ($info["t_id"] !== ""))?($info["t_id"]):''); ?>">
	...
	<script type="text/javascript">
		<?php if(isset($info["t_id"])): ?>Think.setValue("cl_id", <?php echo ((isset($info["cl_id"]) && ($info["cl_id"] !== ""))?($info["cl_id"]):1); ?>);
