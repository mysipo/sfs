...
<script>
	...
	<div class="main-title">
		<h2><?php echo isset($info['node_id'])?'编辑':'新增';?>视频</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				<!-- 基础 -->
				<input type="hidden" name="video_id" value="<?php echo ($info["video_id"]); ?>">
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" name="node_title" class="text input-5x" value="<?php echo ((isset($info["node_title"]) && ($info["node_title"] !== ""))?($info["node_title"]):''); ?>">
						</div>
					</div>
			        <div class="form-item">
						<label class="item-label">视频标识</label>
						<div class="controls">
							<input type="text" name="qcloud_id" class="text input-5x" value="<?php echo ((isset($info["qcloud_id"]) && ($info["qcloud_id"] !== ""))?($info["qcloud_id"]):''); ?>" maxlength="20" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')">
						</div>
					</div>
					<input type="hidden" name="qcloud_app" class="text input-5x" value="<?php echo ((isset($info["qcloud_app"]) && ($info["qcloud_app"] !== ""))?($info["qcloud_app"]):'1251979435'); ?>">

				</div>
				<div class="form-item">
					<input type="hidden" name="node_id" value="<?php echo ((isset($info["node_id"]) && ($info["node_id"] !== ""))?($info["node_id"]):''); ?>">
	...
	<script type="text/javascript">
		<?php if(isset($info["node_id"])): ?>Think.setValue("allow_publish", <?php echo ((isset($info["allow_publish"]) && ($info["allow_publish"] !== ""))?($info["allow_publish"]):1); ?>);
