...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/wwwroot/Public/Admin/css/login.css" media="all">
                ...
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="index.php/Admin/Public/verify">
                            </div>
                        </div>
