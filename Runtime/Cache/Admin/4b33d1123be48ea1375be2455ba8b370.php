...
<script>
	...
	<script src="/adminmanager/Public/static/laydate/laydate.dev.js"></script>
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
		                ...
		                <div class="controls">
		                    ...
		                    <?php if(!empty($info['live_img'])): ?><div id="img"><div class="upload-pre-item" style="width:300px;max-height:200px;"><img src="/adminmanager<?php echo ($info['live_img']); ?>"/>
		                        </div>
		                        </div>
		                    <?php else: ?>
