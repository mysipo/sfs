							...
							<?php case "picture_union": ?><div class="controls">
								...
								<script type="text/javascript">
									...
									function uploadPicture<?php echo ($o_key); ?>(file, data){
										...
										var src = '';
										if(data.status){
											src = data.url || '/mysipo_video' + data.path
											$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
												'<div class="upload-pre-item" val="' + data.id + '"><img src="/mysipo_video' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
											);
														...
														function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
															...
															if(data.status){
																...
																$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
																	'<div class="upload-pre-item" val="' + data.id + '"><img src="/mysipo_video' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
																);
